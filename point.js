class Point {
  ...
  solve() {
    if (this.type == -1) {
      ...
      } else if (this.l1.n == 1 && this.l2.n == 2) {
        ////////////////////////////////////////////////////////////solve linear + quad//////////////////////////////////////////////////
        var y0 = this.l1.p[0].y;
        var y1 = this.l1.p[1].y;
        var x0 = this.l1.p[0].x;
      ...
      } else if (this.l1.n == 1 && this.l2.n == 3) {
        //solve linear + cubic
      }
    } else if (this.l1.type == 0 && this.l2.type == 1) {
      //solve linear + AS
      if (this.l1.n == 1) {
        ...
        if (p.x > this.l2.p[0].x && p.x < this.l2.p[1].x - this.l2.asr) {
          ...
          if (p.y < this.l2.p[1].y && p.y > this.l2.p[0].y + this.l2.asr) {
            ...
            var m =
              (this.l1.p[1].y - this.l1.p[0].y) /
              (this.l1.p[1].x - this.l1.p[0].x);
      ...
      if (this.l2.n == 1) {
        //solve extension and linear
        if (this.l1.p[0].x == this.l1.p[1].x) {
          this.x = this.l1.p[0].x;
          var m =
            (this.l2.p[1].y - this.l2.p[0].y) /
            (this.l2.p[1].x - this.l2.p[0].x);
        ...
        if (
          this.x > max(this.l2.p[0].x, this.l2.p[1].x) ||
          this.x < min(this.l2.p[0].x, this.l2.p[1].x) ||
          this.y > max(this.l2.p[0].y, this.l2.p[1].y) ||
          this.y < min(this.l2.p[0].y, this.l2.p[1].y)
        ) {
          this.x = NaN;
          this.y = NaN;
          this.exists = false;
