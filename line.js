  ...
  render() {
    ...
    if (this.type == 0) {
      ...
      while (t <= 1) {
        ...
        if (
          abs(this.curr.x - w.mx) < 0.5 * this.r &&
          abs(this.curr.y - w.my) < 0.5 * this.r
        ) {
          this.hovering = true;
        }
      }
    ...
    if (this.type == 1) {
      ...
      if (
        (abs(w.mx - this.p[1].x) < 0.5 * this.r &&
          w.my > this.p[0].y + this.asr &&
          w.my < this.p[1].y) ||
        (abs(w.my - this.p[0].y) < 0.5 * this.r &&
          w.mx > this.p[0].x &&
          w.mx < this.p[1].x - this.asr) ||
        (sq(w.mx - this.p[1].x + this.asr) + sq(w.my - this.p[0].y - this.asr) >
          sq(this.asr - 0.5 * this.r) &&
          sq(w.mx - this.p[1].x + this.asr) +
            sq(w.my - this.p[0].y - this.asr) <
            sq(this.asr + 0.5 * this.r) &&
          w.mx > this.p[1].x - this.asr &&
          w.my < this.p[0].y + this.asr)
      ) {
    ...
    if (this.type == 2) {
      ...
      if (mode == 1) {
        if (this.p[0].x == this.p[1].x) {
          if (
            abs(w.mx - this.p[0].x) < 0.5 * this.r &&
            w.my < this.p[0].y - this.r &&
            w.my > this.p[1].y
          ) {
            this.hovering = true;
          } else {
